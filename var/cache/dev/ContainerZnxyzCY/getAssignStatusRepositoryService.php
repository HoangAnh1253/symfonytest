...
{
    /**
     * Gets the private 'App\Repository\AssignStatusRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssignStatusRepository.php';

        return $container->privates['App\\Repository\\AssignStatusRepository'] = new \App\Repository\AssignStatusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
