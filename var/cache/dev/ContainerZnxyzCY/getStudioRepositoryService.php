...
{
    /**
     * Gets the private 'App\Repository\StudioRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StudioRepository.php';

        return $container->privates['App\\Repository\\StudioRepository'] = new \App\Repository\StudioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
