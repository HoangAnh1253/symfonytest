...
class __TwigTemplate_9d3aec76bd1ae67a0ec3cdb09b67a54a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 114
            echo "\t\t\t\t\t\t\t\t\t<option value=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 114), "html", null, true);
            echo ">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "title", [], "any", false, false, false, 114), "html", null, true);
            echo "</option>
\t\t\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\tequipments = ";
        // line 167
        echo json_encode((isset($context["equipments"]) || array_key_exists("equipments", $context) ? $context["equipments"] : (function () { throw new RuntimeError('Variable "equipments" does not exist.', 167, $this->source); })()));
        echo "
...
";
    ...
    {
        return array (  293 => 167,  240 => 116,  229 => 114,  225 => 113,  209 => 100,  191 => 84,  182 => 80,  168 => 71,  164 => 69,  159 => 62,  155 => 61,  151 => 60,  147 => 59,  144 => 58,  139 => 57,  133 => 53,  103 => 22,  92 => 20,  88 => 19,  74 => 7,  67 => 6,  53 => 3,  36 => 1,);
    }
