...
class __TwigTemplate_b419cc615e44e5de2817c893b99ce2da extends Template
{
    private $source;
    private $macros = [];
      ...
      <tbody id=\"equipment-table-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["equipment"]) {
            ...
            <td class=\"equipDesc\">
              ";
            // line 36
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["equipment"], "description", [], "any", false, false, false, 36), "html", null, true);
            echo "
            </td>
          </tr>
        ";
...
{% endblock %}
", "user/myEquipment.html.twig", "/Users/nguyenlamhoanganh/project/symfony/wtf/templates/user/myEquipment.html.twig");
    }
}
