...
\t\t";
        ...
        if (array_key_exists("violations", $context)) {
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["violations"]) || array_key_exists("violations", $context) ? $context["violations"] : (function () { throw new RuntimeError('Variable "violations" does not exist.', 9, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["violation"]) {
                ...
                echo "\t\t\t<div class=\"alert alert-danger alert-dismissible\" role=\"alert\" style=\"display: inline-block\">
                    <div>";
                // line 11
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["violation"], "message", [], "any", false, false, false, 11), "html", null, true);
                echo "</div>
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 28
            echo "\t\t\t\t\t<a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_equipment_filter_by_category", ["category" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 28)]), "html", null, true);
...
\t\t\t\t\t\t<th class=\"text-center\" scope=\"row\">";
            // line 67
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["equipment"], "id", [], "any", false, false, false, 67), "html", null, true);
            echo "</th>
...
\t\t\t\t\t\t<td class=\"equipCategory text-center\">";
            // line 70
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["equipment"], "category", [], "any", false, false, false, 70), "name", [], "any", false, false, false, 70), "html", null, true);
            echo "</td>
...
\t\t\t\t\t\t\t<button onclick=\"addDataToModel('";
            // line 79
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["equipment"], "id", [], "any", false, false, false, 79), "html", null, true);
...
\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 122
            echo "\t\t\t\t\t\t\t\t\t<option value=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 122), "html", null, true);
            echo ">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "title", [], "any", false, false, false, 122), "html", null, true);
            echo "</option>
\t\t\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\tequipments = ";
        // line 175
        echo json_encode((isset($context["equipments"]) || array_key_exists("equipments", $context) ? $context["equipments"] : (function () { throw new RuntimeError('Variable "equipments" does not exist.', 175, $this->source); })()));
        echo "
...
";
    ...
    {
        return array (  318 => 175,  265 => 124,  254 => 122,  250 => 121,  234 => 108,  216 => 92,  207 => 88,  193 => 79,  189 => 77,  184 => 70,  180 => 69,  176 => 68,  172 => 67,  169 => 66,  164 => 65,  158 => 61,  128 => 30,  117 => 28,  113 => 27,  100 => 16,  97 => 15,  87 => 11,  84 => 10,  79 => 9,  77 => 8,  74 => 7,  67 => 6,  53 => 3,  36 => 1,);
    }
